...
export const ocbScenarios: ScenarioItem[] = [
  {
    ...
    options: [
      ...
      },
      {
        id: 's1_B',
        optionKey: 'optB',
        text: '简单告诉她可以查看公司内网的操作指南',
      },
      {
        id: 's1_C',
        optionKey: 'optC',
        text: '等手头的事忙完后，看她是否还需要帮忙再说',
      },
      {
        id: 's1_D',
        optionKey: 'optD',
        text: '继续做自己的事，她如果需要帮忙会主动开口的',
      },
    ],
  },
  {
    ...
    title: '场景二：下班后帮同事赶方案',
    description:
      '今天是周五下午5点半，你已经完成了当天的工作，正准备收拾东西下班。这时你注意到同事小林还在工位上忙碌，她正在赶一份下周一早上要交给客户的方案，但她对方案中涉及的数据整理部分不太擅长，进展缓慢，看起来很焦虑。如果没有人帮忙，她可能需要加班到很晚。你今晚和朋友约了晚餐，但时间还算灵活。',
    options: [
      {
        id: 's2_A',
        optionKey: 'optA',
        text: '主动留下来帮她处理数据部分，告诉朋友晚餐推迟一点',
      },
      {
        id: 's2_B',
        optionKey: 'optB',
        text: '花十分钟快速教她数据处理的方法，然后去赴约',
      },
      {
        id: 's2_C',
        optionKey: 'optC',
        text: '跟她说明天可以早点来帮她，然后先去赴约',
      },
      {
        id: 's2_D',
        optionKey: 'optD',
        text: '跟她说可以问问其他同事或者用AI工具试试，然后下班',
      },
    ],
  },
  {
